...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Barabash_Checkout/billing-address'
            },
            ...
            initialize: function () {
                ...
                $(function() {
                    $(document).ready(function () {
                        ...
                        //$('textarea[name="custom_attributes[custom_field]"]').closest('.field').hide();

                        /*$(document.body).on('click', '.custom-comment-checkbox', function() {
                            console.log($(this).is(':checked'));
                            if ($(this).is(':checked')) {
                                $('textarea[name="custom_attributes[customer_comment]"]').show();
                            } else {
                                $('textarea[name="custom_attributes[customer_comment]"]').hide();
                            }
